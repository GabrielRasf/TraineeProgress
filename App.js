...
export default function App() {
  ...
  const calcularTotalTreinos = (inicio, fim, freq) => {
    ...
    const treinosDiasRestantes = Math.min(diasRestantes, freq);

    return (semanasCompletas * freq) + treinosDiasRestantes;
  };
...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 32, fontWeight: 'bold', color: COLORS.text, marginTop: 20, marginBottom: 20 },
